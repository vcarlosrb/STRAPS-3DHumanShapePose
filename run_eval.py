...
def main(input_path, shape_label_path, gender_label_path, checkpoint_path, device, silhouettes_from):
    ...
    file_path = 'evaluation/results/evaluation_measurement_exp_5.pickle'
    evaluation_file = {
        'pve_neutral': [],
        'height': [],
        'weight': [],
...
if __name__ == '__main__':
    ...
    args.checkpoint = 'checkpoints/straps_model_transfer_learning_checkpoint_exp002_epoch50.tar'
